    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Notifications and updates from your admissions team.</p>
        </div>
        {unread > 0 && (
          <button
            onClick={() => {
        ...
        <div className="flex-1 bg-white rounded-xl border border-gray-200 overflow-hidden">
          ...
          {loading ? <PageLoader /> : msgs.length === 0 ? (
            <EmptyState
              ...
              description="You'll receive notifications here when there are updates on your applications."
            />
          ) : (
