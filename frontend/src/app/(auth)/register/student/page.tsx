...
export default function StudentRegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (form.password !== form.confirmPassword) {
      setError(T(t.registerStudent.passwordsMismatch));
      return;
    }
    setLoading(true);
    try {
    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative">
          ...
          <h1 className="text-3xl font-bold text-white leading-tight mb-3">{T(t.registerStudent.heroTitle)}</h1>
          <p className="text-blue-200 text-sm leading-relaxed max-w-xs">
            {T(t.registerStudent.heroSubtitle)}
          </p>
          <ul className="mt-6 space-y-2">
            {[
              T(t.registerStudent.benefits.b1),
              T(t.registerStudent.benefits.b2),
              T(t.registerStudent.benefits.b3),
              T(t.registerStudent.benefits.b4),
            ].map((item) => (
        ...
        <p className="relative text-blue-400 text-xs">
          {T(t.registerStudent.alreadyHave)}{' '}
          <a href="/login" className="text-white underline">{T(t.registerStudent.signIn)}</a>
        </p>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-10 bg-white overflow-y-auto">
        <div className="w-full max-w-lg">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-1">{T(t.registerStudent.title)}</h2>
          <p className="text-sm text-gray-500 mb-6">{T(t.registerStudent.subtitle)}</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-gray-50 border border-gray-150 rounded-xl p-4 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <label className="bg-white hover:bg-blue-50 text-gray-600 text-[11px] font-semibold px-3 py-1.5 rounded-lg cursor-pointer transition-colors border border-gray-200 flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">{T(t.registerStudent.desiredField)}</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">{T(t.registerStudent.desiredModule)}</label>
            ...
            <button type="submit" disabled={loading}
              ...
              {loading ? T(t.registerStudent.creating) : T(t.registerStudent.createBtn)}
            </button>
          </form>
